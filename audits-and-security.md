...
* **Findings:** 37 total — 2 critical, 3 high, 14 medium, 12 low, 6 informational. Per the report: _"All reported issues were fixed or acknowledged by the development team and subsequently verified by us."_
* **Report:**
...
* **Report:** _to be linked here when published._
...
A security review is incomplete without checking _who_ can pull which lever. As of July 6, 2026:

| Contract                                                                            | Privileged role                         | Holder                                 | Type                   |
| ----------------------------------------------------------------------------------- | --------------------------------------- | -------------------------------------- | ---------------------- |
| ALB token                                                                           | DEFAULT\_ADMIN\_ROLE (OZ AccessControl) | Team Safe / DAO                        | Multisig               |
...
| Token Generator orchestrator                                                        | `owner`                                 | Team deployer EOA `0xDD3705…0aD5`      | Single key             |
| EsProxyMaster                                                                       | `owner`                                 | Team deployer EOA                      | Single key             |
