...
Use the [Vaults](vaults.md) page. Pick a pre-configured Wide / Narrow / Stable range, deposit, and earn pool fees + ALB rewards. The position is wrapped as an ERC-20 share by [Bunni](bunni.md), which means:
...
![New position page](../screenshots/10-new-position.png)

From [app.alienbase.xyz/dashboard](https://app.alienbase.xyz/dashboard) → **New position**, or directly at [app.alienbase.xyz/add](https://app.alienbase.xyz/add). Pick V2 or V3, choose your pair, fee tier, lower price, and upper price. The V3 position is created as a Uniswap-style NFT. You can:
