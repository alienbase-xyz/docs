...
![Token Generator form](../../screenshots/08-token-generator.png)
...
1. **Create a liquidity pool.** [app.alienbase.xyz/liquidity](https://app.alienbase.xyz/liquidity) → V2 (full-range, simplest) or V3 (concentrated).
