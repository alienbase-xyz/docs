...
The plan assumed an initial circulating supply of 25 million ALB, which, due to early sniping and strong community interest, could not be added to the fair launch liquidity pool.

After three weeks of the initial distribution schedule, the community and team agreed to reduce the emission to approximately 4% of total supply per month (a ~46% reduction), equivalent to 8 ALB per second: [https://snapshot.org/#/alienbase-dex.eth/proposal/0x56c418fd7f7fd365b0beba44389807941e3150fb376179ac758fb497f04a999b](https://snapshot.org/#/alienbase-dex.eth/proposal/0x56c418fd7f7fd365b0beba44389807941e3150fb376179ac758fb497f04a999b)
...
The team currently cannot mint tokens without a 14-day timelock (farming emission parameters are timelocked for 7 days).
...
The remaining **5 million** are to be distributed to the team with vesting contracts (which are yet to be deployed).

Of the current farming emissions, 15% of the tokens minted are reserved for the team as an operating budget and reserve. Another 15% is reserved for the DAO and marketing initiatives that bring the protocol forward.
