...
| Currently minted | ~465,000,000 ALB (~91% of cap) <!-- as of 2026-07-06, Basescan --> |
| Circulating supply | ~234,000,000 ALB (~46% of cap) <!-- as of 2026-07-06, CoinGecko --> |
...
The team has a transparent monthly budget approved by DAO vote. The most recent published cycle was governed by [ADIP-01](https://snapshot.org/#/alienbase-dex.eth/proposal/0xae936ad8ddb58b90128ff8da95bb6edded6188ba4c87f2ea724d771cfcc17cac) (Sept 2025 → Feb 2026); team funding is transitioning to the [AIP-5 Line-of-Credit model](#alien-base-2-0-aip-5). The ADIP-01 structure:
...
- **Alien Base** — ~20 pools, the deepest being ALB/WETH (~$172K liquidity) at [`0xbcd2…6fcB`](https://basescan.org/address/0xbcd27A437eBe92555Cee6b5bBeDdAC639a1b6fcB).
- **Uniswap** — 3 pools.
