...
* **Provide liquidity** in Concentrated-Liquidity (V3) pools, or strategy Vaults to earn fees and ALB rewards.
...
| Lifetime swap volume | \~$2.86 B                                                                                   |

For up-to-date market data, see our [Dune dashboard](https://dune.com/sealaunch/alienbase) (the canonical source, built with Sealaunch), [CoinGecko](https://www.coingecko.com/en/coins/alienbase), or [DefiLlama](https://defillama.com/protocol/alien-base). For full contract addresses, see [Contracts](contracts.md). For the full data-source map, see [Data & Analytics](data-and-analytics.md).

## Where can I start?

1. **Track ALB and Alien Base** on [CoinGecko](https://www.coingecko.com/en/coins/alienbase), [CoinMarketCap](https://coinmarketcap.com/currencies/alien-base/), [DexScreener](https://dexscreener.com/base/0x1dd2d631c92b1acdfcdd51a0f7145a50130050c4), and inside [Coinbase Wallet](https://www.coinbase.com/wallet). Add us to your watchlist.
...
| -------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------- |
| **V2 swap** (pool fee)                             | **0.16%**                                                                       | **LPs (50%) + esALB stakers (50%)** |
| **V3 swap** (pool fee)                             | **0.01% / 0.02% / 0.03% / 0.04% / 0.075% / 0.30% / 1.00%** (per fee tier)       | **LPs (50%) + esALB stakers (50%)** |
| **Epsilon Router** protocol fee                    | **0.05% flat fee on any swap**                                                  | esALB stakers                       |
| **Limit / Take Profit** orders                     | **0.01% / 0.05% / 0.10%** (stables / blue chips / other) (+ 0.05% Protocol Fee) | Keeper                              |
| **Stop Loss / Trailing Stop / Trigger DCA** orders | **0.10% / 0.20% / 0.45%** (stables / blue chips / other) (+ 0.05% Protocol Fee) | Keeper                              |
| **Regular DCA** orders                             | **0.01% / 0.10% / 0.20%** (stables / blue chips / other) (+ 0.05% Protocol Fee) | Keeper                              |
...
You can convert back at any time via two paths, mixable: 100% after a 30-day cooldown (no penalty), or 1% instantly every 12 hours. [Full guide](escrowed-alb-esalb/).
...
Source code lives in [github.com/alienbase-xyz](https://github.com/alienbase-xyz/) — note that not every deployed contract has a public repo for reasons of operational secrecy.
...
* [**Governance**](alien-base-dao/) — DAO, Foundation, Labs, AIP index
* [**Builders**](tools-for-projects/token-generator/) — Token Generator and listing your project
...
* [**Archive**](archive/) — deprecated products (Area 51, StableSwap, Carbon orders, B3, Predictions, Lottery)

> _Last updated: July 6, 2026. Found something out of date? Open an issue on_ [_github.com/alienbase-xyz/docs_](https://github.com/alienbase-xyz/docs/issues) _or ping the team on Discord._
