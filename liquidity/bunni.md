...
> _Last updated: July 6, 2026._ Alien Base ships a fork of Bunni alongside its V3 stack.
...
4. The share tokens need to be staked into the Alien Base farming distributor for ALB rewards (auto-staking is in the roadmap).
...
Alien Base's BunniHub code has slightly modified parameters and contains an important bug fix missing in the original protocol. The BunniZap is **lightly adapted** and shares most of its lineage with the audited upstream zap. Full lineage and links: [Audits & Security](../audits-and-security.md).
